// Lexical path infrastructure adapted from compiler/application/module-identity.ts.
// Kept local so the reference runtime has no dependency on the production compiler.
