...
This is not complete S2 diagnostics acceptance. Remaining diagnostic-site attribution, semantic paths/sorting, CSS source maps, source-to-emitted-rule mappings, and IDE/Vite overlay consumption are separate work. The independent reference renderer may omit this optional field and does not import production parsing or IR.
